 ...
 * Copyright (c) 2009-2011 by socketio_socketiotitanium, Inc. All Rights Reserved.
...
//@interface socketio_socketiotitaniumObject : NSObject
//@end

@interface socketio_socketiotitaniumObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[socketio_socketiotitaniumObject class]])
		{
			for (NSString *key in [[(socketio_socketiotitaniumObject*)o modules] allKeys])
			{
