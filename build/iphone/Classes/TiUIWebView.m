...
static NSString * const ksocketio_socketiotitaniumJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_socketiotitaniumInjection
{
	...
	[html appendString:ksocketio_socketiotitaniumJavascript];
...
{
	// attempt to make well-formed HTML and inject in our socketio_socketiotitanium bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _socketiotitaniumInjection]];
