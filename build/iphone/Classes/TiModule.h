...
/**
 The base class for all socketio_socketiotitanium modules
 */
...
/**
 socketio_socketiotitanium Platform calls this method on startup.
 */
-(void)startup;

/**
 socketio_socketiotitanium Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 socketio_socketiotitanium Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 socketio_socketiotitanium Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 socketio_socketiotitanium Platform calls this method on resume.
 @param sender The sender of the event.
 */
