...
//Rare exceptions to indicate a bug in the _socketiotitanium code (Eg, function that a subclass should have implemented)
...
/**
 The base class for socketio_socketiotitanium proxies.
 */
