...
// in simulator we redefine to format for socketio_socketiotitanium Developer console
...
{\
	NSString * exceptionName = [@"org.socketiotitanium." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.socketiotitanium";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIsocketio_socketiotitaniumNativeItemNone = -1, 
	UIsocketio_socketiotitaniumNativeItemSpinner = -2,
	UIsocketio_socketiotitaniumNativeItemProgressBar = -3,
	
	UIsocketio_socketiotitaniumNativeItemSlider = -4,
	UIsocketio_socketiotitaniumNativeItemSwitch = -5,
	UIsocketio_socketiotitaniumNativeItemMultiButton = -6,
	UIsocketio_socketiotitaniumNativeItemSegmented = -7,
	
	UIsocketio_socketiotitaniumNativeItemTextView = -8,
	UIsocketio_socketiotitaniumNativeItemTextField = -9,
	UIsocketio_socketiotitaniumNativeItemSearchBar = -10,
	
	UIsocketio_socketiotitaniumNativeItemPicker = -11,
	UIsocketio_socketiotitaniumNativeItemDatePicker = -12,
	
	UIsocketio_socketiotitaniumNativeItemInfoLight = -13,
	UIsocketio_socketiotitaniumNativeItemInfoDark = -14,
	
	UIsocketio_socketiotitaniumNativeItemDisclosure = -15,
	
	UIsocketio_socketiotitaniumNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all socketio_socketiotitanium instances of
