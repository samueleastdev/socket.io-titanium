...
/**
 Base class for all socketio_socketiotitanium views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the socketio_socketiotitanium view hierarchy (such as wrapped iOS UIViews) was touched.
