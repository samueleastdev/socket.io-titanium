...
@interface socketio_socketiotitaniumObject : KrollCoverageObject {
#else
@interface socketio_socketiotitaniumObject : KrollObject {
#endif
@private
...
extern NSString * socketio_socketiotitanium$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	socketio_socketiotitaniumObject *_socketiotitanium;
    KrollObject* console;
	BOOL shutdown;
